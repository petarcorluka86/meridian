 ...
 *
 * The geometry is exported apart from the presentation because the card's empty
 * state draws the same shape larger and on a tinted tile: one shape at two
 * sizes, rather than two near-misses that drift apart.
 */

export const OVERVIEW_GLYPH = {
  inbox: (
    <>
...
export const InboxIcon = () => (
  <Icon tone="muted" size="lg">
    {OVERVIEW_GLYPH.inbox}
  </Icon>
);

export const TasksIcon = () => (
  <Icon tone="muted" size="lg">
    {OVERVIEW_GLYPH.tasks}
  </Icon>
);
...
export const ClockIcon = () => (
  <Icon tone="muted" size="lg">
    {OVERVIEW_GLYPH.clock}
  </Icon>
);

export const UploadIcon = () => (
  <Icon tone="muted" size="lg">
    {OVERVIEW_GLYPH.upload}
  </Icon>
);
