  ...
  const pages: Array<[string, string, string[]]> = [
    ...
    [
      ...
      [
        ...
        'A phase can be marked “only inside this project”, in its pencil dialog. Its tasks then show nowhere but this page — not on Tasks, not on the Overview — which is for phases whose work is planned rather than actionable yet. The phase wears a project-only pill so a task that seems missing has a visible reason.',
